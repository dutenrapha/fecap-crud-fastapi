...
# Para simplificar, vamos trabalhar com um banco de dados fictício, apenas uma lista chamada db.
db: List[Tarefa] = []
...
# Corrija o endpoint a seguir para que ele seja capaz de adicionar tarefas ao nosso banco de dados. Lembre-se que nosso banco de dados é uma simples lista.
@app.post("/tarefas")
...
# Corrija o endpoint a seguir para que ele seja capaz de deletar itens do banco de dados.
...
# Corrija o endpoint a seguir para que ele seja capaz de atualizar itens do banco de dados.
